...
const { upload, FranchiseUpload, productUpload, brandUpload } = require('../middleware/imageupload')
module.exports = (app) => {
        ...
        app.put('/api/v1/admin/updateProfile', authJwt.verifyToken, brandUpload, auth.updateProfile);
